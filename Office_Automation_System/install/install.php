...
$_SERVERS['vurl']=base64_decode('bS41MTUxNTguY29t');
...
if ( file_exists($lockfile) ) {
	$error = true;
	$message = '<p>OA似乎已经安装过了，请删除 install 文件夹下的所有文件。<br /><br />如果你想重新安装本程序，请先删除 cache 文件夹下的 install.lock 文件，再运行安装程序。</p>';
}
...
版权所有 (C) 2009-2015，oa.cn 保留所有权利。

OA办公系统是由顶级OA信息技术有限公司(OA研发组)独立开发的基于PHP+MySQL的OA系统。OA办公系统为开放式管理系统，免费供大家使用，学习，交流， 任何人都可以从互联网上免费下载，并可以在不违反本协议规定和非商业用途的前提下进行使用。
开发商：顶级OA信息技术有限公司
官方网址： www.oa.cn  
开发团队：OA研发组
...
3、请务必仔细阅读本授权协议，在您同意授权协议的全部条件后，即可继续TOA的安装。即：您一旦开始安装TOA，即被视为完全同意本授权协议的全部内容，如果出现纠纷，我们将根据相关法律和协议条款追究责任。
	...
	<?php elseif ( $step == 3 ) :?>
		...
		<tr>
			...
			<td><input type="text" name="dbuser" value="" class="input" /> Mysql账号</td>
		</tr>
		<tr>
			<td align="right">数据库密码：</td>
			<td><input type="text" name="dbpwd" value="" class="input" /> Mysql密码,不能为空</td>
		</tr>
		<tr>
			<td align="right">数据库名称：</td>
			<td><input type="text" name="dbname" value="toa" class="input" />  数据库名称,以字母开头</td>
		</tr>
		<!--<tr>
		...
		<tr>
			...
			<hr noshade="noshade" >
				...
				<input type="hidden" name="dbprefix" value="toa_" />
				<input type="button" class="button" onClick="history.back();" value="&lt;&lt; 上一步" style="float:left" />
				<input type="submit" value="下一步 &gt;&gt;" class="button" />
	...
	<?php elseif ( $step == 4 ) :?>
		<tr><th colspan="2">第四步：设置管理员帐号<hr noshade="noshade" ></th></tr>
		<?php 
		...
		?>
			...
			<tr>
				...
				<td><input type="text" name="blogurl" class="input" value="<?php echo $blogurl?>" /></td>
			</tr>
			<tr>
				<td align="right">管理员帐号：</td>
				<td><input type="text" name="username" class="input" value="admin" /></td>
			</tr>	
			<tr>
	...
	<?php elseif ( $step == 5 ) :?>
		<tr><th colspan="2">第五步：检查数据合法性<hr noshade="noshade" ></th></tr>
		<?php
	...
	<?php elseif ( $step == 6 ) :?>
		<tr><th colspan="2">第六步：导入数据，完成安装<hr noshade="noshade" ></th></tr>
		<tr><td>
		...
		<?php
			...
			$userin=$name."(*)".$person."(*)".$phone."(*)".$tel."(*)".$mail."(*)".$blogurl."(*)OA";
...
<p id="copyright">Copyright &copy; 2009-2016  <a href="http://www.oa.cn" target="_blank">顶级OA信息技术有限公司</a> All Rights Reserved.</p>
</body>
</html>