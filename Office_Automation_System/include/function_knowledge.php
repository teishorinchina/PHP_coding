...
function GET_document_PUBLIC_LIST($fatherid=0,$selid=0,$layer=0,$strid=0,$uid=0,$type=1)
{
	...
	$str="";
    global $db;
	$query = $db->query("SELECT * FROM ".DB_TABLEPRE."document_type where father='$fatherid' and type='".$type."' $wheresql ORDER BY id Asc  ");
	...
	GET_document_PUBLIC_LIST($row['id'],$selid,$layer+1,$strnum,$uid,$type);
