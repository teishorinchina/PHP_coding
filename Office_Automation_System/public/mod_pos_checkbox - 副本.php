...
global $db;
$query = $db->query("SELECT * FROM ".DB_TABLEPRE."position where father='$fid' ORDER BY id Asc");
$html='';
while ($row = $db->fetch_array($query)) {
	$blog = $db->fetch_one_array("SELECT * FROM ".DB_TABLEPRE."position where father='".$row['id']."'   ORDER BY id Asc");
